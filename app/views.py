...
def test():
    ...
    if content:
        common.send_email('Test',0,'Test Message',str(content),'gary@mclarenwilliams.com.au')
    else:
        common.send_email('Test',0,'Test Message','No content','gary@mclarenwilliams.com.au')
